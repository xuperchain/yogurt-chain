...
import (
	...
	"github.com/xuperchain/yogurt-chain/ychain/kernel/common/xaddress"
	...
	"github.com/xuperchain/yogurt-chain/ychain/kernel/engines/xuperos/agent"
	"github.com/xuperchain/yogurt-chain/ychain/kernel/engines/xuperos/common"
	"github.com/xuperchain/yogurt-chain/ychain/kernel/engines/xuperos/miner"
	"github.com/xuperchain/yogurt-chain/ychain/kernel/engines/xuperos/parachain"
...
func LoadChain(engCtx *common.EngineCtx, bcName string) (*Chain, error) {
	...
	// 初始化链运行环境上下文
	log.Info("load chain > init chain ctx", "bcName", bcName)
...
func (t *Chain) initChainCtx() error {
	...
	// 12. XRandom 创建
	if err = t.relyAgent.CreateXRandom(); err != nil {
		return err
	}
	t.log.Trace("create XRandom succ", "bcName", t.ctx.BCName)
	return nil
}
