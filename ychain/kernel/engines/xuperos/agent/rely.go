...
import (
	...
	statctx "github.com/xuperchain/yogurt-chain/ychain/bcs/ledger/xledger/state/context"
	...
	cctx "github.com/xuperchain/yogurt-chain/ychain/kernel/consensus/context"
	cdef "github.com/xuperchain/yogurt-chain/ychain/kernel/consensus/def"
	...
	"github.com/xuperchain/yogurt-chain/ychain/kernel/engines/xuperos/xtoken"
	xtokenInter "github.com/xuperchain/yogurt-chain/ychain/kernel/engines/xuperos/xtoken/base"
	...
	"github.com/xuperchain/yogurt-chain/ychain/kernel/permission/acl"
	aclBase "github.com/xuperchain/yogurt-chain/ychain/kernel/permission/acl/base"
	actx "github.com/xuperchain/yogurt-chain/ychain/kernel/permission/acl/context"
	cryptoClient "github.com/xuperchain/yogurt-chain/ychain/lib/crypto/client"
...
func (t *ChainRelyAgentImpl) CreateXRandom() error {
	ctx := t.chain.Context()
	xctx, err := xrandom.NewCtx(ctx)
	if err != nil {
		return err
	}
	err = xrandom.NewManager(xctx)
	if err != nil {
		xctx.GetLog().Error("CreateXRandom() failed", "error", err)
		return err
	}
	return err
}
