...
import (
	...
	"github.com/xuperchain/yogurt-chain/geth/accounts/keystore"
	"github.com/xuperchain/yogurt-chain/geth/common"
	"github.com/xuperchain/yogurt-chain/geth/common/fdlimit"
	"github.com/xuperchain/yogurt-chain/geth/common/hexutil"
	"github.com/xuperchain/yogurt-chain/geth/core"
	"github.com/xuperchain/yogurt-chain/geth/core/rawdb"
	"github.com/xuperchain/yogurt-chain/geth/core/txpool"
	"github.com/xuperchain/yogurt-chain/geth/core/types"
	"github.com/xuperchain/yogurt-chain/geth/core/vm"
	"github.com/xuperchain/yogurt-chain/geth/crypto"
	"github.com/xuperchain/yogurt-chain/geth/crypto/kzg4844"
	"github.com/xuperchain/yogurt-chain/geth/eth"
	ethcatalyst "github.com/xuperchain/yogurt-chain/geth/eth/catalyst"
	"github.com/xuperchain/yogurt-chain/geth/eth/downloader"
	"github.com/xuperchain/yogurt-chain/geth/eth/ethconfig"
	"github.com/xuperchain/yogurt-chain/geth/eth/filters"
	"github.com/xuperchain/yogurt-chain/geth/eth/gasprice"
	"github.com/xuperchain/yogurt-chain/geth/eth/tracers"
	"github.com/xuperchain/yogurt-chain/geth/ethdb"
	"github.com/xuperchain/yogurt-chain/geth/ethdb/remotedb"
	"github.com/xuperchain/yogurt-chain/geth/ethstats"
	"github.com/xuperchain/yogurt-chain/geth/graphql"
	"github.com/xuperchain/yogurt-chain/geth/internal/ethapi"
	"github.com/xuperchain/yogurt-chain/geth/internal/flags"
	"github.com/xuperchain/yogurt-chain/geth/les"
	lescatalyst "github.com/xuperchain/yogurt-chain/geth/les/catalyst"
	"github.com/xuperchain/yogurt-chain/geth/log"
	"github.com/xuperchain/yogurt-chain/geth/metrics"
	"github.com/xuperchain/yogurt-chain/geth/metrics/exp"
	"github.com/xuperchain/yogurt-chain/geth/metrics/influxdb"
	"github.com/xuperchain/yogurt-chain/geth/miner"
	"github.com/xuperchain/yogurt-chain/geth/node"
	"github.com/xuperchain/yogurt-chain/geth/p2p"
	"github.com/xuperchain/yogurt-chain/geth/p2p/enode"
	"github.com/xuperchain/yogurt-chain/geth/p2p/nat"
	"github.com/xuperchain/yogurt-chain/geth/p2p/netutil"
...
var (
	...
	MinerBeaconURLFlag = &cli.StringFlag{
		Name:     "miner.beaconurl",
		Usage:    "This address is used to request random numbers.Only used when consensus is Yogurt",
		Category: flags.MinerCategory,
	}
	MinerBeaconPubKeyFlag = &cli.StringFlag{
		Name:     "miner.beaconpubkey",
		Usage:    "The public key is used to verify the returned result.Only used when consensus is Yogurt",
		Category: flags.MinerCategory,
	}
...
func setMiner(ctx *cli.Context, cfg *miner.Config) {
	...
	if ctx.IsSet(MinerBeaconURLFlag.Name) {
		cfg.BeaconURL = ctx.String(MinerBeaconURLFlag.Name)
	}
	if ctx.IsSet(MinerBeaconPubKeyFlag.Name) {
		cfg.BeaconPubKey = ctx.String(MinerBeaconPubKeyFlag.Name)
	}
}
...
func MakeChain(ctx *cli.Context, stack *node.Node, readonly bool) (*core.BlockChain, ethdb.Database) {
	...
	// NOTE: to verify header when import blocks
	if config.Yogurt != nil {
		config.Yogurt.BeaconURL = ctx.String(MinerBeaconURLFlag.Name)
		config.Yogurt.BeaconPubKey = ctx.String(MinerBeaconPubKeyFlag.Name)
	}
