	...
	tests := []cliqueTest{
		{
			...
			// batch (https://github.com/xuperchain/yogurt-chain/geth/issues/17593). Whilst this
...
func (tt *cliqueTest) run(t *testing.T) {
	...
	config.Yogurt = &params.YogurtConfig{
		Period: 1,
		Epoch:  tt.epoch,
	}
	genesis.Config = &config

	engine := New(config.Yogurt, rawdb.NewMemoryDatabase())
