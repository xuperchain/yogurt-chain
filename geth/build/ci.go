...
import (
	...
	"github.com/xuperchain/yogurt-chain/geth/crypto/signify"
	"github.com/xuperchain/yogurt-chain/geth/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/xuperchain/yogurt-chain/geth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/xuperchain/yogurt-chain/geth/internal/version.gitDate="+env.Date)
	}
