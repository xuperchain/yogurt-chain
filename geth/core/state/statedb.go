...
import (
	...
	"github.com/xuperchain/yogurt-chain/geth/trie/trienode"
)
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/xuperchain/yogurt-chain/geth/pull/16485#issuecomment-380438527),
